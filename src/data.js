...
const getAirlineIdByAirlineName = (name) => {
  let airline = airlines.filter(airline => airline['name'] === name)
  return airline[0]["id"]
}

const getAirportCodeByName = (name) => {
  let airport = airports.filter(airport => airport["name"] === name);
...
export default { routes, airlines, airports, getAirlineById, getAirportByCode, getAirlineIdByAirlineName, getAirportCodeByName };